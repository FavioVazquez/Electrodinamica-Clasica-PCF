...
\begin{equation}
 E_{pe} = \frac{q}{(r^2+l^2)} + \frac{q}{(r^2+l^2)} = 2 \frac{q}{(r^2+l^2)},
\end{equation}
...
\begin{equation}
 E_{pe} = \frac{2q}{(r^2+l^2)}\cos{\theta},
\end{equation}

y viendo la figura \eqref{fig:problema1fig2} vemos que podemos escribir 

\begin{equation}
 \cos{\theta} = \frac{\text{CA}}{\text{HIP}} = \frac{l}{(r^2+l^2)^2},
\end{equation}

entonces 

\begin{equation}
 E_{pe} = \frac{2q}{(r^2+l^2)} \frac{l}{(r^2+l^2)^2} = \frac{2ql}{(r^2+l^2)^{3/2}},
\end{equation}
